...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelProductName.Text = "Scr@tchP@d"
        ...
        Me.TextBox1.Text = "This program gives the user the ability to work on several short text messages at" & _
    " one time, as well as changing the text/background font and color."
        '
        'AboutBox1
        '
